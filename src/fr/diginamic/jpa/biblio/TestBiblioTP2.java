...
/**
 * Classe qui crée en base de données les instances du TP2. Décommentez les
 * appels aux methodes avant de lancer l'execution.
 * 
...
public class TestBiblioTP2 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// INSERT
			// Livre l = ls.insertLivre(efm, new Livre("L'audace de vaincre", "Jean
			// Latherguy"));
